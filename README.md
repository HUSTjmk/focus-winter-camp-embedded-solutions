...
- TASK2：**任务要求**     
  ...
  - TASK2.1：**Audio**
    ...
    - TASK2.1.0：**看看学长为你们准备的资料**  
      ...
      网址：[B站官方教程](https://www.bilibili.com/video/BV1DG4y1u7mb/)
    - TASK2.1.1：**实现语音播放**   
    ...
    - *TASK2.1.4：**语言交互的另一种solution**         
      ESP32是乐鑫公司发布的一款MCU,它因其便利的物联网功能风靡全球。其中ESP32s3等芯片内部集成了音频通道，并且可烧写简单的离线语音识别模型，实现你和桌宠的对话。查阅相关资料，基础任务做完的可以联系jmk，试着用它实现语言对话功能  
  - TASK2.2：**Display**  
  ...
  - TASK2.4：**Sensor**  
    ...
    - *TASK2.4.2：**手势传感的另一种solution** 
      之前的手势传感是使用传统的物理方法，但其实我们还可以采用摄像头+视觉模型进行开发。我们回到[语音交互的另一种solution](#audio-another-solution)，我们的老朋友ESP32支持多种摄像头接口，并且支持轻量的深度学习模型ESP32-DL。想要解锁该任务，请在保证之前**基础任务和其他附加任务完成**的前提下联系jmk，他会觉得你十分高能🔥
  - TASK2.5：**Combination** 
