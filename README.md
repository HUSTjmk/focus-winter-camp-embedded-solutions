...
- TASK2：**任务要求**     
  ...
  - TASK2.4：**Sensor**  
    ...
    - *TASK2.4.2：**手势传感的另一种solution** 
      之前的手势传感是使用传统的物理方法，但其实我们还可以采用摄像头+视觉模型进行开发。我们回到[语音交互的另一种solution](#audio-another-solution)，我们的老朋友ESP支持多种摄像头接口，并且支持轻量的深度学习模型ESP32-DL。想要解锁该任务，请在保证之前**基础任务和其他附加任务完成**的前提下联系jmk，他会觉得你十分高能🔥
  - TASK2.5：**Combination** 
