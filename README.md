...
- TASK2：**基础任务**  
  - TASK2.0：**机械小狗的建模与装配**
    ...
    - TASK 2.0.1：**机械小狗的装配**\
      ...
      最后，将装配体打包，将装配体、干涉检查截图以及TASK4一起发送至邮箱64987369@qq.com  
...
- TASK4：**心得体会**  
  ...
  请写一篇关于你在冬令营收获了什么的文章，文体不限，字数不少于300字，文件名为“小队名称+机械组+姓名”，并连同先前的文件一起发送到64987369@qq.com  
...
- **学习路径 && 资料说明：**  
 ...
 - **效果呈现**   
  ...
  2. 相关的代码请发送到movingon_2023@qq.com，命名为“小队名称+代码完成人姓名（可多位）”。当然你也可以创建自己的github仓库，并向群管理员**jmk**私信你的github仓库地址
  3. 期待在结营时看到你们的实物成果哦~
